# -*- coding: utf-8 -*-
#Rotates thymio clockwise to the speed given in arguments. Stops when the limit time (2nd argument) is reached
#If the third argument is 'r', it goes anticlockwise
import dbus
...
def Braitenberg(t,s):
    ...
    while(t>0):
        ...
        network.SetVariable("thymio-II", "motor.right.target", [speed*-1])
        t=t-1
        time.sleep(1) 
